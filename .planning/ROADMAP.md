...
- ✅ **v2.0 Enhancements** -- Phases 5-8 (shipped 2026-03-04, audited PASSED 29/29)
- **v2.1 Hardening** -- full-project review remediation: correctness/security fixes, test+CI infrastructure, consistency refactor, docs (in progress on branch v2.1-hardening; see .planning/v2.1-PLAN.md)
...
- [x] **Phase 5: Scene Composition** - AI can wire complete game scenes with signals, instanced subscenes, groups, and batch property operations -- completed 2026-03-04
- [x] **Phase 6: Project Configuration & Assets** - AI can configure input actions, create shaders, and export builds headlessly -- completed 2026-03-04
- [x] **Phase 7: Animation & TileMap** - AI can create animated characters and build tile-based levels -- completed 2026-03-04
- [x] **Phase 8: Runtime Inspection & Reload** - AI can inspect a running game's scene tree and restart after changes -- completed 2026-03-04
...
Plans:
- [x] 05-01-PLAN.md -- Parser groups enhancement + GDScript operations backend
- [x] 05-02-PLAN.md -- TypeScript composition tool handlers + tests
...
Plans:
- [x] 06-01-PLAN.md -- GDScript backend operations + execGodot timeout extension
- [x] 06-02-PLAN.md -- Config + Shader TypeScript tool handlers + tests
- [x] 06-03-PLAN.md -- Export tool handlers + tests + index.ts wiring
...
Plans:
- [x] 07-01-PLAN.md -- GDScript backend operations for animation and tilemap domains
- [x] 07-02-PLAN.md -- Animation TypeScript tool handlers + tests
- [x] 07-03-PLAN.md -- TileMap TypeScript tool handlers + tests + index.ts wiring
...
Plans:
- [x] 08-01-PLAN.md -- GDScript runtime_helper.gd autoload + TypeScript inspection tools (inspect_scene_tree, inspect_node, inspect_group) + tests
- [x] 08-02-PLAN.md -- restart_project hot-reload tool + tests + index.ts registration
...
| 5. Scene Composition | v2.0 | 2/2 | Complete | 2026-03-04 |
| 6. Project Configuration & Assets | v2.0 | 3/3 | Complete | 2026-03-04 |
| 7. Animation & TileMap | v2.0 | 3/3 | Complete | 2026-03-04 |
| 8. Runtime Inspection & Reload | v2.0 | 2/2 | Complete | 2026-03-04 |
